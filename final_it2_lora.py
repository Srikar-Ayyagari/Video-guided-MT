...
# model_path = "multimodal_indictrans2_best_lora_r_16_a_32_clip.pth"
...
num_epochs = 50
patience = 8   # stop if no improvement for 3 epochs
...
for ep in tqdm(range(num_epochs)):
    ...
    if val_loss < best_val_loss:
        ...
        epochs_no_improve = 0
        torch.save(model.state_dict(), "multimodal_indictrans2_best_lora_r_16_a_32_cluster_clip.pth")
...
translate_test_set("multimodal_indictrans2_best_lora_r_16_a_32_cluster_clip.pth", output_path="output_amb_test_lora_r_16_a_32_cluster_clip.hi")
# ----- Run Ambiguous Test-Time Inference -----
# translate_test_set("/home/cfiltlab/24m0741/multimodal_indictrans2_best_lora_r_16_a_32_cluster_clip.pth", output_path="output_amb_test_lora_r_16_a_32_annote_cluster_clip.hi", test_loader=amb_test_loader)
